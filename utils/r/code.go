...
const (
	...
	ERROR_USER_DISABLE      = 1014
	ERROR_USER_NO_ROLE      = 1015
	ERROR_ONCE_PASSWORD     = 1016
	ERROR_PHONE_EXIST       = 1017
...
var codeMsg = map[int]string{
	...
	ERROR_USER_DISABLE:      "用户已被锁定",
	ERROR_USER_NO_ROLE:      "用户无角色，不可登录",
	ERROR_ONCE_PASSWORD:     "两次密码不一致",
	ERROR_PHONE_EXIST:       "该号码已绑定其他账户",

	ERROR_TOKEN_NOT_EXIST:  "TOKEN 不存在，请重新s登陆",
