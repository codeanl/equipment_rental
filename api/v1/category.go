...
func (*Category) SaveOrUpdate(c *gin.Context) {
	r.SendCode(c, categoryService.SaveOrUpdate(utils.BindJson[req.SaveOrUpdateCategory](c)))
}

// Delete 删除
func (*Category) Delete(c *gin.Context) {
	r.SendCode(c, categoryService.Delete(utils.BindJson[req.Delete](c)))
}

// GetTreeList 列表
func (*Category) GetTreeList(c *gin.Context) {
	r.SuccessData(c, categoryService.GetTreeList())
}
